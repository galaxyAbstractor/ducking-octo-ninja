...
ALTER TABLE `messages_users`
  ADD CONSTRAINT `messages_users_ibfk_3` FOREIGN KEY (`author`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
